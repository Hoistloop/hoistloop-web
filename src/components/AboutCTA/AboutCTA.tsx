...
export default function AboutCTA({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-[50px] border-x border-b border-neutral-800 p-20 max-laptop:h-[349px] max-laptop:gap-10 max-laptop:p-[60px] max-mobile:h-auto">
      ...
      <div className="flex size-full flex-row items-center justify-between gap-5 rounded-xl border border-neutral-800 px-10 py-6 max-laptop:rounded-[10px] max-laptop:px-[30px] max-laptop:py-[20px] max-mobile:flex-col">
