...
export default function StepCard({ step, title, description }: StepCardProps) {
  return (
    <div className="flex h-[463px] flex-col gap-[50px] border-b border-r border-neutral-800 px-[50px] py-[100px] max-laptop:h-[402px] max-laptop:gap-10 max-laptop:px-40 max-laptop:py-80 max-mobile:h-[334px] max-mobile:gap-[30px] max-mobile:px-6 max-mobile:py-10">
