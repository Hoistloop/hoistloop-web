...
export default function FeatureHeader({
  ...
  return (
    <div className="flex flex-col justify-between gap-[50px] px-[50px] max-laptop:gap-10 max-laptop:px-10 max-mobile:gap-[30px] max-mobile:px-4 ">
